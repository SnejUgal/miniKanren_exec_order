...
class ExportedNumbersTest {
    ...
    fun testMul5x5all() {
        ...
        println("$a * $b")
        run(5, { r: Term<OlegLogicNumber> -> multo(a, b, r) })
        UnificationsController.onFinish()
    }
    ...
    fun testExpo3x2() {
        ...
        println("$base^$power")
        val answers = run(1, { r: Term<OlegLogicNumber> -> expo(base, power, r) })
    ...
    fun testLogo8base2() {
        ...
        run(1, { q: Term<OlegLogicNumber> -> logo(n, b, q, r) })
    ...
    fun testRepeatedMul1() {
        ...
        run(1, { r: Term<OlegLogicNumber> -> repeated_mul(a, b, r) })
        UnificationsController.onFinish()
    }
    ...
    fun testOddMul1() {
        ...
        run(1, { r: Term<OlegLogicNumber> -> odd_multo(q, a, b, r) })
        UnificationsController.onFinish()
    }
